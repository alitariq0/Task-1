...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        easyPaisa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intent != null){
                    ...
                    Intent playStoreEP = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=pk.com.telenor.phoenix&hl=en"));
        ...
        jazzCash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = getPackageManager().getLaunchIntentForPackage("com.techlogix.mobilinkcustomer");

                if (intent != null){
                    startActivity(intent);
                }
                else {
                    Intent playStoreJC = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.techlogix.mobilinkcustomer&hl=en"));
